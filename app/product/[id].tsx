...
// app/product/[id].tsx
import { getProductById, Product } from "@/hooks/firebaseutitlits";
        ...
        <View style={styles.imageWrap}>
          {/* {discount > 0 && (
            <View style={styles.discountTag}>
              <Text
                style={{ fontSize: 12, fontWeight: "800", color: Colors.white }}
              >
                {discount}% OFF
              </Text>
            </View>
        ...
        <View style={{ padding: Spacing.md }}>
          ...
          >
            <Text
              style={{
                ...
                fontWeight: "600",
                color:
                  product?.instock === true ? Colors.accent : Colors.danger,
              }}
            >
          ...
          {product?.description && (
            <Card style={{ marginTop: Spacing.md }}>
              <Text style={[Typography.h4, { marginBottom: 6 }]}>
                Description
              </Text>
              <Text
                style={{
          ...
          <Card style={{ marginTop: Spacing.md }}>
            ...
            {[
              ...
              {
                label: "Availability",
                value: product?.instock !== false ? "Available" : "Unavailable",
              },
            ].map((row) => (
              <View key={row.label} style={styles.detailRow}>
                <Text
                  style={{ fontSize: 13, color: Colors.textMuted, width: 100 }}
                >
                  {row.label}
                </Text>
                <Text
          ...
          <Card style={{ marginTop: Spacing.md }}>
            ...
            <View style={{ gap: 8 }}>
              ...
              <InfoLine
                emoji="🆓"
                text="Free delivery on orders above Rs. 2,000"
              />
              <InfoLine emoji="✅" text="100% genuine, licensed product" />
              <InfoLine
                emoji="🕐"
                text="Order anytime — we're available 24/7"
              />
            </View>
          </Card>
        </View>
